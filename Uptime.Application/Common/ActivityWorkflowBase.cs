...
public abstract class ActivityWorkflowBase<TContext>(IWorkflowStateRepository<TContext> stateRepository, ILogger<WorkflowBase<TContext>> logger)
    : WorkflowBase<TContext>(stateRepository, logger), IActivityWorkflowMachine
