...
public abstract class ActivityWorkflowBase<TContext>(IWorkflowRepository repository, ILogger<WorkflowBase<TContext>> logger)
    : WorkflowBase<TContext>(repository, logger: logger), IActivityWorkflowMachine
