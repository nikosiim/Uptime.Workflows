...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Workflows.Core.Data.OutboundNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Workflows.Core.Data.Workflow", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Workflows.Core.Data.WorkflowHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Workflows.Core.Data.WorkflowPrincipal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Workflows.Core.Data.WorkflowTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Workflows.Core.Data.WorkflowTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Workflows.Core.Data.Workflow", b =>
                {
                    b.HasOne("Workflows.Core.Data.WorkflowPrincipal", "InitiatedBy")
                        .WithMany()
                        .HasForeignKey("InitiatedById")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Workflows.Core.Data.WorkflowTemplate", "WorkflowTemplate")
                        .WithMany("Workflows")
            ...
            modelBuilder.Entity("Workflows.Core.Data.WorkflowHistory", b =>
                {
                    b.HasOne("Workflows.Core.Data.WorkflowPrincipal", "PerformedBy")
                        .WithMany()
                        .HasForeignKey("PerformedById")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Workflows.Core.Data.Workflow", "Workflow")
            ...
            modelBuilder.Entity("Workflows.Core.Data.WorkflowTask", b =>
                {
                    b.HasOne("Workflows.Core.Data.WorkflowPrincipal", "AssignedBy")
                        .WithMany()
                        .HasForeignKey("AssignedById")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Workflows.Core.Data.WorkflowPrincipal", "AssignedTo")
                        .WithMany()
